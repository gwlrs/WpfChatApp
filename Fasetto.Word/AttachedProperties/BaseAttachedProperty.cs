...
namespace Fasetto.Word
{
         ...
         where Parent : new()
    {
        ...
        /// <summary>
        /// Fired the value changes
        /// </summary>
        public event Action<DependencyObject, DependencyPropertyChangedEventArgs> ValueChanged = (sender, e) => { };

        /// <summary>
        /// Fired the value changes even if it is the same
        /// </summary>
        ...
        /// <param name="e">The argumnents for event</param>
        ...
        /// </summary>
        /// <param name="d"> The UI element that had it's property changed</param>
        /// <param name="value">The argumnents for event</param>
        ...
        /// </summary>
        /// <param name="sender">The UI element that this propeerty was changed for</param>
        ...
        /// <summary>
        /// The method that is called when any attached property of this type is changed even if value is the same 
        /// </summary>
        /// <param name="sender">The UI element that this propeerty was changed for</param>
